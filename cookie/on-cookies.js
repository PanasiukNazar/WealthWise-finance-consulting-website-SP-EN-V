...
class OnCookies {
    ...
    createBanner() {
        ...
        settingsHeading.className =
            'ont-font-medium ont-text-3xl ont-tracking-wide';
        ...
        this.setTextContent(
            ...
            texts[savePreferencesButton.id],
        );
    ...
    createCookieCategory(title, description, idSuffix) {
        ...
        desc.className =
            'ont-text-sm ont-text-slate-600 ont-leading-6 ont-mt-2';
    ...
    savePreferences() {
        ...
        document
            .getElementById('cookie-preference-icon')
